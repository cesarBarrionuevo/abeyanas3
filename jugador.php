...
<div class="row no-gutters">
        ...
        <div class="info-jugador col-12 col-sm-12 col-lg-6">
            <div class="ficha-jugador">
                    ...
                    <h3 class="posicion-jugador"><?php echo $registro['posicion'] ?></h3>
                    <dl class="atributos">
                    ...
                    <?php }elseif ($registro['idCat'] == '2') { ?>
                        <a class="boton-volver btn btn-lg btn-danger btn-block" style="font-family: 'Spartan'; font-size: 16px" data-pant-chica="VOLVER" data-pant-grande="VOLVER A EL PLANTEL" href="reserva.php"  title="Volver al plantel"></a>
